    ...
    <div className="flex px-5 md:px-0 flex-col mt-16 gap-10">
      <div className="flex flex-col gap-10">
        <MagicContainer className="max-w-5xl mx-auto flex flex-col gap-10">
          ...
          >
            ...
            <p className="pr-7 text-xl">
              Energy Panel Maroc est fier de proposer les chauffe-eau solaires
              de la marque espagnole Novasolar, synonymes de qualité et
              d&apos;efficacité énergétique.
            </p>
            <div className="pointer-events-none absolute inset-0 h-full bg-gradient-to-r from-green/35 to-blue/70" />
          </MagicCard>
          <MagicCard
            className="flex w-full gap-7 cursor-pointer flex-col items-center justify-center overflow-hidden bg-[radial-gradient(var(--mask-size)_circle_at_var(--mouse-x)_var(--mouse-y),#ffaa40_0,#9c40ff_50%,transparent_100%)] p-10 shadow-2xl"
            borderWidth={3}
          >
            <h2 className="text-4xl text-start w-full mb-3 font-semibold">
        ...
        <MagicContainer className="flex max-w-5xl mx-auto flex-col gap-10">
          <MagicCard
            className="flex mx-auto max-w-7xl w-full cursor-pointer flex-col items-center justify-center overflow-hidden bg-[radial-gradient(var(--mask-size)_circle_at_var(--mouse-x)_var(--mouse-y),#ffaa40_0,#9c40ff_50%,transparent_100%)] p-10 shadow-2xl"
            borderWidth={3}
          >
            <div>
              <h2 className="text-4xl text-start w-full mb-3 font-semibold">
